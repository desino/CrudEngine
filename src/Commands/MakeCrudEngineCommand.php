    ...
    */
    ...
    protected function updateRoutes(): void
    {
        ...
        $lines = [
            ...
            "Route::match(['get', 'post'], '{$this->snakeCasePluralName}/create', [{$controllerClassName}, 'create'])->name('{$this->camelCasePluralName}.create');",
            "Route::match(['get', 'post'], '{$this->snakeCasePluralName}/{id}/edit', [{$controllerClassName}, 'edit'])->name('{$this->camelCasePluralName}.edit');",
